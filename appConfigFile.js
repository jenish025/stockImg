...
export const authUrl = `https://unsplash.com/oauth/authorize?client_id=9QquI2C70aHLzMU3WKxUSqnhXC9fgUKT1glJ-6q4dpw&redirect_uri=${RedirectUri}&response_type=code&scope=public+read_user+write_user+read_photos+write_photos+write_likes+write_followers+read_collections+write_collections`;
